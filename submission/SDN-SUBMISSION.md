...
2. **Name:** APlankMaker
3. **Description:** Makes planks with a clean setup flow, Simple auto-routing, Advanced sawmill controls, owned-supply processing, Ironman-safe behavior, runtime editing, breaks, and live statistics. Optional BETA workflows include GE restocking and selling plus a separate Lunar Plank Make mode with rune and staff staging, altar switching, and safe-world hopping. For the most stable experience, use Simple or Advanced sawmill mode and leave BETA options disabled until you are comfortable testing newer features.
