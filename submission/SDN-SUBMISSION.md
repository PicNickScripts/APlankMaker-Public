...
2. **Name:** APlankMaker
3. **Description:** Makes planks at supported sawmills with Simple auto-routing and Advanced controls for Auburnvale, Prifddinas, Woodcutting Guild, and Varrock. Includes Lunar Plank Make with AFK, Active, and Random casting. Supports owned supplies, Ironman-safe behavior, breaks, and optional equipment setup. GE restocking and selling are experimental.
